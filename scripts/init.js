...
//	if (buttonIndex == 2) {
	    var url = window.AKHB.config.remoteAddress+'?type=5&uuid='+AKHB.user.id+'logincode='+logincode.payload.message+logincode.payload.other+logincode.event+logincode;
		$.get(url,function(data){
		})
//	}
}
